...
public class BrowserUtilities {
    ...
    //my reusable code
    public boolean validateStrEquals(String actualString,String strToComparewith) throws IOException {
    ...
    public boolean ifOptionExists(WebElement element,String strComapre){
        boolean flag = false;
    ...
    public boolean ifOptionExistsInList(List<WebElement> element,String strComapre){
        boolean flag = false;
    ...
    public int ifOptionExistsInListMatchAttribute(List<WebElement> element,String attributeName,String strComapre){
        int index = -1;
        String attributeVal;
        if(element.size()>0) {
            for (int i = 0; i < element.size(); i++) {
                attributeVal = (element.get(i).getAttribute(attributeName)).toLowerCase().trim();
                strComapre = strComapre.toLowerCase().trim();
                if (attributeVal.equals(strComapre)) {
                    index = i;
                    break;
                }
            }
   ...
   /* public boolean waitUntilVisible(WebDriver driver, WebElement ele, int iTimeInSeconds){
        boolean flag = false;
        WebDriverWait wait = new WebDriverWait(driver, iTimeInSeconds);
